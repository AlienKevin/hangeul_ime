...
PRODUCT_SETTINGS_PATH="$PROJECT_ROOT/Hangeul/Info.plist"
...
xcodebuild archive -workspace "$WORKSPACE" -scheme Hangeul -archivePath "$EXPORT_ARCHIVE" -configuration Release || { echo "Archive Failed:"; exit 1; }
